...
public static class TetrominoTemplates {
    ...
    private readonly static List<Vector2> zShapeCoordinates = new List<Vector2>() {
        new Vector2(0, 0), new Vector2(1, 0), new Vector2(0, 1), new Vector2(-1, 1)
    };
    ...
    private readonly static List<Vector2> jShapeCoordinates = new List<Vector2>() {
        new Vector2(0, 0), new Vector2(-1, 0), new Vector2(0, 1), new Vector2(0, 2)
    };
    private readonly static List<Vector2> oShapeCoordinates = new List<Vector2>() {
    ...
    private static Dictionary<ShapeType, List<Vector2>> shapeCoordinatesDict = new Dictionary<ShapeType, List<Vector2>>() {
        {ShapeType.S, sShapeCoordinates}, {ShapeType.L, lShapeCoordinates}, {ShapeType.O, oShapeCoordinates},
        {ShapeType.I, iShapeCoordinates}, {ShapeType.T, tShapeCoordinates}, {ShapeType.Z, zShapeCoordinates},
        {ShapeType.J, jShapeCoordinates}
    };
